...
n_first = 130; %the start of data order
n_last = 130; %the end of data order
...
time_reso = 0.01; %sec, the resolotion is higher, the frequency resolution is lower
...
%     figure
%     pspectrum(minus_mean_sound_data,fs,'Leakage',0.5,'spectrogram','FrequencyLimits',[low_fre high_fre],'TimeResolution',time_reso)
    figure
    [pxx0,f0] = pspectrum(minus_mean_sound_data,fs, 'Leakage',0.5,'FrequencyLimits',[low_fre high_fre]);    
    plot(f0,pow2db(pxx0))
...
%     figure
%     pspectrum(minus_mean_sound_data_filter,fs,'Leakage',0.5,'spectrogram','FrequencyLimits',[low_fre high_fre],'TimeResolution',time_reso)
    figure
    [pxx1,f1] = pspectrum(minus_mean_sound_data_filter,fs, 'Leakage',0.5,'FrequencyLimits',[low_fre high_fre]);    
    plot(f1,pow2db(pxx1))
